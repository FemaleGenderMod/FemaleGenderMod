...
**1) Can you include a male bulge?**
...
**2) If I were to play on a realm with my friends, and we all used this mod, would they see my character with my settings?**
...
**7) Is this mod compatible with Minecraft: Bedrock Edition (Mobile)?**
*No, and it never will be.*

**8) Why when I press 'H' ('G' in versions before 1.21.6) it opens the customization screen, and not the player list?**
...
**9) Could you change the player model's height or give it more curvy looking hips?**
...
**10) Why are my settings not saving?**
