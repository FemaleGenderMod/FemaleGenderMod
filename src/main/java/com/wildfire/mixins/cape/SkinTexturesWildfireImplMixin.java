...
abstract class SkinTexturesWildfireImplMixin implements SkinTexturesWildfire {
    private @Unique @Nullable ClientAssets.TextureAsset wildfiregender$overriddenCapeTexture = null;

    public void wildfiregender$overrideCapeTexture(@Nullable ClientAssets.TextureAsset texture) {
        this.wildfiregender$overriddenCapeTexture = texture;
    }

    public @Nullable ClientAssets.TextureAsset wildfiregender$getOverriddenCapeTexture() {
