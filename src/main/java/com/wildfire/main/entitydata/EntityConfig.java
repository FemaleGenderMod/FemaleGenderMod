...
public class EntityConfig {
     ...
     *
     * @apiNote Configuration settings for {@link PlayerConfig}s may not be immediately available upon being returned, and may take several seconds to be populated if
     * loaded from the {@link com.wildfire.main.cloud.CloudSync cloud sync server}.
     */
    @NotNull
    ...
    /**
     * Only used in the case of {@link ArmorStand armor stands}; returns {@code true} if the player who equipped the armor stand's chestplate has their jacket layer
     * visible.
     */
