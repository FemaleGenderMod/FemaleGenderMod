...
import com.wildfire.client.lang.FormatSplitter.MessageFormatComponent;
...
/**
 * From <a href="https://github.com/mekanism/Mekanism/blob/1.21.x/src/datagen/main/java/mekanism/client/lang/UpsideDownLanguageProvider.java">Mekanism</a>
 */
    ...
    private static String convertMessageFormatCode(MessageFormatComponent component) {
        ...
        if (formatStyle != null && component.isChoice()) {
            ...
            try {
                ...
                WildfireGender.LOGGER.warn("Failed to convert '{}' to an upside down choice format. Got: '{}' which was invalid.", formatStyle, newFormatStyle);
